...
if (!empty($search)) {
    $search_term = "%$search%";
    $stmt = $conn->prepare("SELECT * FROM medicines WHERE medicine_name LIKE ? OR company_name LIKE ? LIMIT ?, ?");
    ...
    $count_stmt = $conn->prepare("SELECT COUNT(*) AS total FROM medicines WHERE medicine_name LIKE ? OR company_name LIKE ?");
...
<body>
    ...
    <header class="header">
        ...
        <div class="search-form">
            <input type="search" id="search-box" placeholder="Search medicines..." value="<?= htmlspecialchars($search) ?>">
        ...
        <div class="table-container">
            ...
            <table id="medicineTable">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="5">No medicines found<?= !empty($search) ? ' matching your search' : '' ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
